...
public class MusicPlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Updating UI with media player progress
        ...
        // SeekBar listener to update music position
        ...
        // Volume Button: Show on-screen volume control
        ...
        // Repeat Button: Toggle repeat on/off
        repeatButton.setOnClickListener(v -> {
            isRepeatOn = !isRepeatOn;
            String repeatStatus = isRepeatOn ? "Repeat ON" : "Repeat OFF";
            Toast.makeText(MusicPlayerActivity.this, repeatStatus, Toast.LENGTH_SHORT).show();
        });

        // Shuffle Button: Toggle shuffle on/off
        shuffleButton.setOnClickListener(v -> {
            isShuffleOn = !isShuffleOn;
            String shuffleStatus = isShuffleOn ? "Shuffle ON" : "Shuffle OFF";
            Toast.makeText(MusicPlayerActivity.this, shuffleStatus, Toast.LENGTH_SHORT).show();
        });

        // Equalizer Button: Open Audio Effect Control Panel
